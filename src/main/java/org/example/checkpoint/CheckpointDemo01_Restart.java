...
/**
 * Desription: 演示flink-checkpoint+重启策略实现状态恢复
 *
 * @ClassName CheckpointDemo01
 * @Author Zhanyuwei
 * @Date 2021/2/12 16:31
 * @Version 1.0
 **/
public class CheckpointDemo01_Restart {
    public static void main(String[] args) throws Exception {
        ...
        // 上面的设置表示:如果5分钟内job失败不超过3次，自动重启，每次重启间隔3s （如果5分钟内程序失败超过3次，则程序退出）
